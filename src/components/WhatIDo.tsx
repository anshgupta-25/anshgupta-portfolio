        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building AI-driven automation agents using LangChain, Selenium,
                and Playwright to extract, summarize, and process data—reducing
                manual workflows by 80%+.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CLOUD & DEVOPS</h3>
              <h4>Scalable Infrastructure & Deployment</h4>
              <p>
                Designing scalable cloud solutions with Microsoft Azure, Google
                Cloud, and Oracle Cloud. Certified across platforms with hands-on
